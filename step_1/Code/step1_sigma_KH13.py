...
for j in range(real_tot):   
    ...
    dest_file = "../Data/KH13_Reg_Sigma/test01/kh13stalled_sigma_"+str(j)+str("_")+str(filename)
    #str(filename)
...
for j in range(arg_number, arg_number+real_tot):   
    ...
    dest_file = "../Data/KH13_Stalled_Sigma/test01/kh13stalled_sigma_"+str(j)+str("_")+str(filename)
